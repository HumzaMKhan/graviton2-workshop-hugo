...
Start by reviewing contents of the RDS MySQL 8 database definition in file graviton2-workshop/graviton2/rds_graviton/rds_restore.py
...
1. We'll use the snapshot we created from original x86-64 instance to restore new Graviton2 database.
